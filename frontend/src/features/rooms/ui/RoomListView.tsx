...
export function RoomListView() {
  ...
  return (
    <div className="min-h-screen bg-[#0a0e14] px-8 py-8">
      {/* Header */}
      <div className="max-w-4xl mx-auto">
        <div className="flex items-center gap-4 mb-8">
          ...
          <button className="ml-auto px-4 py-2.5 rounded-xl bg-primary hover:bg-primary/80 text-white text-xs font-bold uppercase tracking-wider transition-colors flex items-center gap-2 shadow-lg shadow-primary/20">
