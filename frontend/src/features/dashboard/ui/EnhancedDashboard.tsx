...
import { AiOptimizedScheduleWidget } from './AiOptimizedScheduleWidget'
import { GroupChallengesWidget } from './GroupChallengesWidget'
  ...
  return (
    <div className="space-y-6">
      ...
      <section className="rounded-2xl bg-white/5 border border-white/10 backdrop-blur-xl p-8">
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-8 lg:gap-12">
            ...
            <div className="text-center">
              <p className="text-[10px] text-muted-foreground uppercase tracking-widest font-bold mb-1">Focus Score</p>
              <p className="text-3xl font-black text-white flex items-center justify-center gap-1">
                94 <Zap className="h-4 w-4 text-[#FFD93D]" />
              </p>
            </div>

            <div className="text-center">
              <p className="text-[10px] text-muted-foreground uppercase tracking-widest font-bold mb-1">Current Project</p>
              <p className="text-sm font-bold text-primary underline underline-offset-4 decoration-primary/40 cursor-pointer hover:decoration-primary transition-all">
                Nebula UI Design
              </p>
            </div>
          </div>
      ...
      <div className="grid grid-cols-12 gap-6">
        {/* Left column: AI Schedule */}
        <div className="col-span-12 lg:col-span-4 flex flex-col gap-4">
          <AiOptimizedScheduleWidget model={aiOptimizedScheduleMock} />
          <button
            type="button"
      ...
      {/* ─── Full-width: Group Challenges ──────────────────────── */}
      <GroupChallengesWidget model={groupChallengesMock} />
    </div>
  )
}
